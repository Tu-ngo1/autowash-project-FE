              ...
              return (
                <div className="space-y-3">
                  ...
                  {paymentMethodSelect === "BANK_TRANSFER" && (
                    <div className="rounded-xl border border-cyan-400/30 bg-cyan-950/30 p-3.5 text-xs font-bold text-cyan-200 flex items-center gap-3">
                      <span className="material-symbols-outlined text-[22px] text-[#72f3ff]">point_of_sale</span>
                      <span>Thanh toán qua máy quét MoMo / POS bên ngoài (Nhận tín hiệu âm thanh thông báo)</span>
                    </div>
                  )}
                </div>
              );
